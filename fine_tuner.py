...
https://colab.research.google.com/drive/176NSaYjc2eeI-78oLH_F9-YV3po3qQQO?usp=sharing#scrollTo=SDVQ04fGRb1v
"""
...
class T5FineTuner(pl.LightningModule):
    ...
    def set_dataset_loader(self, f):
        """Assigns the dataset loader function, externally defined"""
        self.get_dataset = f
